...
output_dir = "../data/out/" # e.g. output_dir = "C:/some_folder/output/"
...
if(data_file != FALSE){
  save(list=c(eem_name,"abs_data"),file = paste0(output_dir,data_file,"_",format(Sys.time(), "%Y%m%d_%H%M%S"),".RData"))
}
```
# Sample overview
